const questions = [
	...
	},
	{
		...
		answers: [
			...
			"Лише у державну казну, нехай самі розбираються"
		],
	},
	{
		question: "Скільки відсотків від податку з вашої зарплати варто спрямовувати неприбутковим організаціям," +
			" які реалізують суспільно-корисні проекти?",
		answers: [
	...
	{
		question: "Станом на  2012 рік  вже 6 років як працював механізм відсоткового відрахування у Польщі. Як " +
			"думаєте, яка кількість поляків у 2012 році скористалась можливістю відрахувати 1% від свого податку " +
	...
	{
		question: "Яка мотивація спрямовувати неприбутковим організаціям 2% від податку на доходи фізичної особи" +
			" є найближчою вам?",
		answers: [
	...
	{
		question: "Чи відомо вам про неприбуткові організації, які займаються суспільно-корисними справами і ви " +
			"хотіли підтримати їхню діяльність?",
		answers: [
			"Так!",
			"Ні, але я загуглю такі, що відповідатимуть моїм пріоритетам",
			"Ні, не знаю і не маю мотивації дізнаватись"
		],
	},
	{
		question: "Чи готові ви у найближчий час почати спрямовувати 2% від вашого податку на дохід неприбутковим" +
			" організаціям, діяльність яких вважаєте корисною?",
		answers: [
			"Так, звісно!",
			"Напевне…",
	...
	{
		question: "Як думаєте, чи використали поляки механізм відсоткового відрахування у своїй країні, щоб допомогти" +
			" українцям, які після повномасштабного вторгнення росії були змушені шукати тимчасовий дім у Польщі?",
		answers: [
			"Так, без сумніву!",
			"Ні, це неможливо",
			"Напевно?"

...
const experts = [
	...
	},
	{
		...
		'info': [
			...
			},
			{
				...
				'imagePath': 'photo.png',
				'comment': 'Підтримую! «Історична права» чекає на цей закон!'
			},
			{
				'name': 'Олег Карпенко',
			...
			{
				'name': 'Архієпископ Євстратій',
				'position': 'Архієпископ Чернігівського і Ніжинського',
				'imagePath': 'photo.png',
				'comment': 'Благодійність – одна з головних біблійних чеснот. В Україні в умовах війни як ніколи стала' +
					' активною та життєво потрібною волонтерська праця. Серед інших Православна церква України постійно' +
					' надає гуманітарну допомогу нашим воїнам, людям по всій Україні, особливо в найбільш постраждалих' +
					' від війни місцях.\n' +
					'Запровадження механізму відсоткового відрахування, коли кожен з нас зможу перерахувати частину' +
					' свого податку на користь корисної організації, буде додатковим стимулом підтримувати громадський' +
					' сектор, який є надійною опорою для країни.'
			}
		]
	},
	{
		...
		'info': [{
			...
			'imagePath': 'experts_images/TarasChmut.webp',
	...
	},
	{
		...
		'info': [{
			...
			'imagePath': 'experts_images/SerhiiPr.jpeg',
			'comment': 'Тут буде коментар'
		}]
	}
];
